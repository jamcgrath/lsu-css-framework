...
listCheckData: {
	head: ["Class", "value"],
	rows:[
		["list-style-check-small",["font-size: var(--list-fs)","line-height: var(--list-line-height)","margin: var(--list-margin)","padding-left: var(--list-padding-left)","list-style: none","background-position: var(--list-bg-pos)","background-repeat: no-repeat","background-image: var(--list-check-svg-sm)"]],
		["list-style-check-medium",["--list-line-height: 1.5","--list-fs: var(--body)","--list-padding-left: 21px","--list-bg-pos: 0 -2px","font-size: var(--list-fs)","line-height: var(--list-line-height)","margin: var(--list-margin)","padding-left: var(--list-padding-left)","list-style: none","background-position: var(--list-bg-pos)","background-repeat: no-repeat","background-image: var(--list-check-svg-md)"]],
		["list-style-check-large",["--list-line-height: 1.6","--list-fs: var(--title-7)","--list-padding-left: 30px","--list-bg-pos: 0 -3px","<br/>font-size: var(--list-fs)","line-height: var(--list-line-height)","margin: var(--list-margin)","padding-left: var(--list-padding-left)","list-style: none","background-position: var(--list-bg-pos)","background-repeat: no-repeat","background-image: var(--list-check-svg-lg)"]],
	]
}
---
